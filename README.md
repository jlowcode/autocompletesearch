# Fabrik List Auto Complete Search <img src="/images/jlowcodelogo.png" width="102px" align="right" />
...
1. Tentar ao se criar um plugin adicionar scripts javascript apenas em arquivos separados, adicionados no arquivo principal .php, para que não ocorra problemas de ao realizar uma soliticação ajax em uma página o script de um plugin interferir na requisição de outro plugin.
